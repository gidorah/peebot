...
-   **Models:**
    -   `TelemetryChannel`: Metadata for each telemetry sensor, derived from `docs/PUIList.xml`.
        -   Fields:
            ...
            -   `public_pui`: CharField (unique, e.g., "NODE3000005") (Public Program Unique Identifier)
...
-   **Seeding:**
    ...
    -   Ensure only `NODE3000005` (UPA) is set to `is_active=True`.
-   **Testing:**
...
3.  Only `NODE3000005` is active after seeding.
