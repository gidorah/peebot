...
- **Logic**: Sliding Window analysis, trend detection, external triggers (Twitter).
...
6. **Act**: Trigger external services (e.g., `twitter_client`).
...
- `services/`: `TwitterClient` for notifications.
